var Root = React.createClass({
  ...
  handleChange: function(evt) {
    evt.preventDefault();
    this.setState({candyNames: evt.target.value});
  },
        ...
        <div className="row">
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="form group">
              ...
              <input type="text" className="form-control" value={this.state.formCandy}
              id="candyName" placeholder="Candy Name" onchange={this.handleChange}/>
            </div>
            <button className="btn btn-default">Creaete</button>
          </form>
        </div>
      </div>
    );
